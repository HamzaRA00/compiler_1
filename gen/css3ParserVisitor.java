 ...
 */
public interface css3ParserVisitor<T> extends ParseTreeVisitor<T> {
	/**
	...
	/**
	 * Visit a parse tree produced by {@link css3Parser#keyframeBlock}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitKeyframeBlock(css3Parser.KeyframeBlockContext ctx);
	/**
